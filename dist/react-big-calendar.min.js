!(function (e, t) {
  ...
  if ('function' == typeof Symbol && Symbol.for) {
    ...
    ;(z = W('react.element')),
      (L = W('react.portal')),
      (D.Fragment = W('react.fragment')),
      (D.StrictMode = W('react.strict_mode')),
      (D.Profiler = W('react.profiler')),
      (j = W('react.provider')),
      (A = W('react.context')),
      (F = W('react.forward_ref')),
      (D.Suspense = W('react.suspense')),
      (I = W('react.memo')),
      (U = W('react.lazy'))
  }
  ...
  ;(D.Children = {
    ...
    (D.Component = Y),
    (D.PureComponent = K),
    (D.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = ue),
  ...
  var xe = { PREVIOUS: 'PREV', NEXT: 'NEXT', TODAY: 'TODAY', DATE: 'DATE' },
    ...
    Oe = Object.keys(_e).map(function (e) {
      return _e[e]
    })
  function De(e, t) {
  ...
  var yr = 'top',
    ...
    Mr = Sr.reduce(function (e, t) {
      return e.concat([t + '-' + xr, t + '-' + _r])
    }, []),
    Cr = [].concat(Sr, [Er]).reduce(function (e, t) {
      return e.concat([t, t + '-' + xr, t + '-' + _r])
    }, []),
    Tr = [
      'beforeRead',
      'read',
  ...
  var Ou = Zo && 'TextEvent' in window && !_u,
    Du = Zo && (!xu || (_u && 8 < _u && 11 >= _u)),
            ...
            : (function (e, t) {
                ...
                switch (e) {
                  ...
                  case 'keypress':
                    ...
                    return null
                  case 'compositionend':
                    return Du && 'ko' !== t.locale ? null : t.data
                }
              })(e, n)) &&
      ...
      if (t) {
        ...
        if (!Pf(e, t)) {
          if (!(t = Ls(n.nextSibling)) || !Pf(e, t))
            return (e.flags = (-1025 & e.flags) | 2), (Cf = !1), void (Df = e)
          Tf(Df, n)
        }
        ;(Df = e), (Mf = Ls(t.firstChild))
      } else (e.flags = (-1025 & e.flags) | 2), (Cf = !1), (Df = e)
    }
  }
  function Nf(e) {
    for (
  ...
  function zf(e) {
    ...
    } else Mf = Df ? Ls(e.stateNode.nextSibling) : null
    return !0
  }
  function Lf() {
    ;(Mf = Df = null), (Cf = !1)
          ...
          if (((e = wf(gf.current)), zf(t))) {
            ...
            switch (n) {
              ...
              case 'option':
                break
              default:
                'function' == typeof a.onClick && (r.onclick = Ds)
            }
            ...
            switch (n) {
              ...
              case 'select':
                ...
                break
              default:
                'function' == typeof o.onClick && (e.onclick = Ds)
            }
            Ts(n, r) && (t.flags |= 4)
          }
  ...
  function rv(e, t) {
    ...
    if (((r = Ol(e, e === wp ? Ep : 0)), (t = xl), 0 === r))
      ...
      15 === t
        ? ((n = iv.bind(null, e)),
          null === Oc ? ((Oc = [n]), (Dc = pc(bc, jc))) : Oc.push(n),
          (n = xc))
        : 14 === t
  ...
  var Eg = function (e) {
    ...
    Dg = Eg(
      ...
      ? Eg
      : function (e) {
          return Sg(e) && _g.call(e, 'callee') && !Og.call(e, 'callee')
        },
    Mg = Dg,
    Cg = {},
    Tg = {
  ...
  var hy = function (e, t, n, r, o, a) {
    ...
    Ry = Ey(wy),
    Ny = ky
  ;((my && Ny(new my(new ArrayBuffer(1))) != Dy) ||
    (gy && Ny(new gy()) != Sy) ||
    (yy && Ny(yy.resolve()) != xy) ||
    (by && Ny(new by()) != _y) ||
    (wy && Ny(new wy()) != Oy)) &&
            ...
            var n = this,
              ...
              i = function (t) {
                ;(r = setTimeout(function () {
                  ...
                  (o = ib('touchmove', function () {
                    return u()
                  })),
                  (a = ib('touchend', function () {
                    return u()
                  }))
              },
              l = ib('touchstart', i),
    ...
    Db = function (e, t, n, r) {
      ...
      for (; ++o < a; ) {
        ...
        if (i && l[2]) {
          ...
          if (!(void 0 === d ? kb(c, s, 3, r, f) : d)) return !1
        }
      }
      return !0
    },
  ...
  function Ab(e, t) {
    ...
    return (n.cache = new (Ab.Cache || jb)()), n
  }
  Ab.Cache = jb
  var Fb = Ab
  var Ib =
    ...
    Wb = (function (e) {
      ...
      return (
        ...
        e.replace(Ib, function (e, n, r, o) {
          t.push(r ? o.replace(Ub, '$1') : n || e)
        }),
        t
      )
    })
  var Hb = function (e, t) {
    ...
    Bb = sg,
    $b = En,
    Yb = Ht ? Ht.prototype : void 0,
    qb = Yb ? Yb.toString : void 0
  var Kb = function e(t) {
      if ('string' == typeof t) return t
      if (Bb(t)) return Vb(t, e) + ''
      if ($b(t)) return qb ? qb.call(t) : ''
      var n = t + ''
  ...
  var ew = function (e, t) {
      return Xb(e) ? e : Gb(e, t) ? [e] : Jb(Zb(e))
    },
    tw = En
  var nw = function (e) {
  ...
  var pw = function (e, t) {
    ...
    vw = function (e, t, n) {
      for (var r = -1, o = (t = lw(t, e)).length, a = !1; ++r < o; ) {
        var i = dw(t[r])
  ...
  var Mw = Tb,
    Cw = function (e, t) {
      return yw(e) && bw(t)
        ...
        : function (n) {
            var r = mw(n, e)
            return void 0 === r && r === t ? gw(n, e) : hw(t, r, 3)
          }
    },
    Tw = Ew,
    Pw = sg,
    Rw = function (e) {
      return Ow(e) ? xw(Dw(e)) : _w(e)
    }
  var Nw = function (e) {
  ...
  var Fw = function (e, t, n) {
    ...
    if (!r) return -1
    var o = null == n ? 0 : jw(n)
    return o < 0 && (o = Aw(r + o, 0)), zw(e, Lw(t), o)
  }
  function Iw(e) {
    var t = e.dateRange,
      n = e.unit,
  ...
  function Uw(e) {
    var t,
      ...
      i = []
    for (t = 0; t < e.length; t++) {
      for (r = e[t], n = 0; n < a.length && Hw(r, a[n]); n++);
              ...
              for (
                ...
                if (s) {
                  ...
                  if (this.canRenderSlotEvent(c, d)) {
                    ...
                    p && i.push(gb(n, p, l + '_gap')),
                      i.push(gb(n, d, l, v)),
                      (a = o = f + 1)
                  } else
                    p && i.push(gb(n, p, l + '_gap')),
                      i.push(gb(n, 1, l, this.renderShowMore(t, o))),
                      (a = o += 1)
                } else o++
              }
    ...
    return ok(function (e) {
      for (
        var t = e.range,
          ...
          a = e.accessors,
          l = e.localizer,
          u = Iw({ dateRange: t, localizer: l }),
          s = u.first,
          c = u.last,
          f = n.map(function (e) {
            return (function (e, t, n, r) {
              var o = Iw({ dateRange: t, localizer: r }),
                a = o.first,
                i = o.last,
                l = r.diff(a, i, 'day'),
    ...
    var t = e.style,
      ...
      T = i(
        ...
        h
          ...
          : o(
              { top: pE(O), width: pE(D), height: pE(_) },
              l ? 'right' : 'left',
              pE(M)
            )
      )
        ...
        if (h.current) {
          ...
          if (t) {
            var n,
              ...
              a = [],
              i = a
            ;(a = [EE(t.children[0]), EE(t.children[1])]),
              (i[0] === a[0] && i[1] === a[1]) ||
    ...
    function o() {
      ...
      return (
        ...
        (e.handleViewChange = function (t) {
          t !== e.props.view && I_(t, e.props) && e.props.onView(t)
          var n = e.getViews()
